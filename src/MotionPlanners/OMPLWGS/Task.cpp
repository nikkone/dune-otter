...
namespace MotionPlanners
{
  ...
  namespace OMPLWGS
  {
    ...
    struct Task: public DUNE::Tasks::Task
    {
      ...
      {
        try{
          m_con = new ENCGIS::DBconnection(m_args.dbPath, SQLITE_OPEN_READONLY, m_args.epsg);
          pointCheck = new ENCGIS::isPointInLayerStatement("deparepolygon", "geometry", m_con->db, m_args.epsg);

...
DUNE::ChartsDatabase::LatLonDist::LatLonDist(const ob::SpaceInformationPtr &si)
...
ompl::base::Cost DUNE::ChartsDatabase::LatLonDist::stateCost(const ob::State *) const
 {
     return identityCost();
 }
  
ompl::base::Cost DUNE::ChartsDatabase::LatLonDist::motionCost(const ob::State *s1, const ob::State *s2) const
 {
...
ompl::base::Cost DUNE::ChartsDatabase::LatLonDist::motionCostHeuristic(const ob::State *s1, const ob::State *s2) const
 {
   //std::cout << "Heuristic" << std::endl;
     return ob::Cost(si_->distance(s1, s2));
 }

 ompl::base::InformedSamplerPtr DUNE::ChartsDatabase::LatLonDist::allocInformedStateSampler(const ob::ProblemDefinitionPtr &probDefn, unsigned int maxNumberCalls) const
 {

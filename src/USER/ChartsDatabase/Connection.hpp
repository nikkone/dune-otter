...
#ifndef DUNE_CHARTSDATABASE_GENERAL_HPP_INCLUDED_
#define DUNE_CHARTSDATABASE_GENERAL_HPP_INCLUDED_
  ...
  namespace ChartsDatabase
  {
    ...
    public:
      ...
      public:
        ...
        double checkPlanMinDepth(const IMC::PlanSpecification* plan, double currentLat=-1.0, double curentLon=-1.0, std::string table="deparetable");
        ...
        bool checkPlanLanding(const IMC::PlanSpecification* plan, double currentLat=-1.0, double curentLon=-1.0, std::string table="lndaretable");
        ...
        std::string planToWKT(const IMC::PlanSpecification* plan, double currentLat=-1.0, double curentLon=-1.0);

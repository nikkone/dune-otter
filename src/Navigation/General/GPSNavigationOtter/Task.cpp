...
//***************************************************************************
// Author: Ricardo Martins and Nikolai LAuvås                               *
//***************************************************************************
    ...
    namespace GPSNavigationOtter
    {
      ...
      struct Task: public DUNE::Tasks::Task
      {
          ...
          DUNE::Tasks::Task(name, ctx)
        {
          ...
          param("GPS has IMU", m_args.gpsHasImu)
          .defaultValue("false")
          .description("If false, phi and theta set to zero.");

          param("GPS has Yaw", m_args.gpsHasYaw)
          .defaultValue("false")
          .description("If false, psi is set to cog.");

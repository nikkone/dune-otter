...
private:
    ...
    void send_motor_speed_cmd(int16_t desiredSpeed);
    ...
    //int8_t _pin_onoff;     // Pin number connected to Torqeedo's on/off pin. -1 to disable turning motor on/off from autopilot
    //int8_t _pin_de;        // Pin number connected to RS485 to Serial converter's DE pin. -1 to disable sending commands to motor
    //int16_t _options;      // options bitmask

...
//***************************************************************************
// Author: Ricardo Martins (sligthly modified by Nikolai Lauvås)            *
//***************************************************************************

#ifndef TQread_HPP_INCLUDED
#define TQread_HPP_INCLUDED
...
namespace Actuators
{
  namespace TQreader
  {
    ...
    static const char c_line_term = (char)0xad;

    class TQSerialReader: public Concurrency::Thread
    {
    public:
      //! Constructor.
      //! @param[in] task parent task.
      //! @param[in] handle I/O handle.
      TQSerialReader(Tasks::Task* task, IO::Handle* handle):
        m_task(task),
        m_handle(handle)
      {

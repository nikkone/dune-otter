...
namespace SourceEstimators
{
  namespace FishTagXKF
  {
    class EKF: public FishTagXKF::KalmanFilter{
        public:
        EKF();
        void constructCandR(DUNE::Math::Matrix receiverPositions, DUNE::Math::Matrix RDOA, DUNE::Math::Matrix tagDepth, bool newMeasurement[3], bool validCombination[3], Matrix xHatInn);

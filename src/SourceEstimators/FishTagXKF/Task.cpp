  ...
  namespace SourceEstimators
  {
      namespace FishTagXKF
      {
        ...
        struct Task: public DUNE::Tasks::Periodic
        {
          ...
          void findFishPosition(const IMC::TBRFishTag &receiver1, const IMC::TBRFishTag &receiver2, const IMC::TBRFishTag &receiver3) {
            ...
            double RDOA_i[] = {m_args.speed_of_sound_in_water*((static_cast<double>(receiver1.unix_timestamp) - receiver2.unix_timestamp) * 1000.0 + (static_cast<double>(receiver1.millis) - receiver2.millis))/1000.0,
                               m_args.speed_of_sound_in_water*((static_cast<double>(receiver2.unix_timestamp) - receiver3.unix_timestamp) * 1000.0 + (static_cast<double>(receiver2.millis) - receiver3.millis))/1000.0,
                               m_args.speed_of_sound_in_water*((static_cast<double>(receiver3.unix_timestamp) - receiver1.unix_timestamp) * 1000.0 + (static_cast<double>(receiver3.millis) - receiver1.millis))/1000.0};
            ...
            if(validCombination[0] || validCombination[1] || validCombination[2])
            {
              ...
              double NED2[3];
              double NED3[3];
              toNEDframe(receiver1, m_refCoord, NED1);
              toNEDframe(receiver2, m_refCoord, NED2);
              toNEDframe(receiver3, m_refCoord, NED3);

              double receiverPositions_i[] = {NED1[0], NED2[0],NED3[0],
                                              NED1[1], NED2[1],NED3[1],
                                              NED1[2], NED2[2],NED3[2]};

              double tagDepth_i[] = {receiver1.trans_data*0.392,receiver2.trans_data*0.392,receiver3.trans_data*0.392}; 

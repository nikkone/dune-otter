...
void EKF::constructCandR(DUNE::Math::Matrix receiverPositions, DUNE::Math::Matrix RDOA, DUNE::Math::Matrix tagDepth, bool newMeasurement[3], bool validCombination[3], Matrix xHatInn)
    {
      ...
      if(m12 == 1)
      {
        ...
        newMeasurement[0] = 0; newMeasurement[1] = 0;
      }
      ...
      if(m23 == 1)
      {
        ...
        newMeasurement[1] = 0; newMeasurement[2] = 0;
      }
      ...
      if(m31 == 1)
      {
        ...
        newMeasurement[2] = 0; newMeasurement[0] = 0;
      }

      double depth = m12*(tagDepth(0,0) + tagDepth(1,0))/2 +
                      m23*(tagDepth(1,0) + tagDepth(2,0))/2 +
                      m31*(tagDepth(2,0) + tagDepth(0,0))/2;

...
void OMPLintegrationENCGIS::ChartsDBMotionValidator2::defaultSettings()
{
...
bool OMPLintegrationENCGIS::ChartsDBMotionValidator2::checkMotion(const ob::State *s1, const ob::State *s2,
